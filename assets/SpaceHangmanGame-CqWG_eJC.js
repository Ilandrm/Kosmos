import{a as W}from"./GameFlowService-KhDp4Eco.js";import{d as j,G as V,r as s,m as b,b as A,e as E,s as P,_ as F,c as i,a as u,g as q,h as y,l as k,F as S,j as x,t as w,k as Z,o as n}from"./index-B-0Ub0wv.js";const J=j({name:"SpaceHangmanGame",components:{GameInstruction:V},setup(){const e=["Astre","Comète","Soleil","Terre","Lune","Etoile"],l="abcdefghijklmnopqrstuvwxyz".split(""),o=s(""),p=s([]),m=s([]),r=s(0),d=6,t=s(!1),c=s(!1),v=s(!1),f=s("Devinez le mot lié à l'espace !"),g=s(40),C=s(!1),N=s(!1),M=s(!0),T=s({title:"Pendu Spatial",players:"1 joueur",time:"30 secondes",instruction:"Devinez le mot en utilisant les lettres à votre disposition"}),I=b(()=>t.value||c.value||v.value),$=b(()=>r.value>=d?`<svg width='200' height='200' xmlns='http://www.w3.org/2000/svg'>
          <defs>
