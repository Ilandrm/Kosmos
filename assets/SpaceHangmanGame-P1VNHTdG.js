import{a as W}from"./GameFlowService-CUMmPH9U.js";import{d as j,G as V,r as s,m as k,b as A,e as E,s as P,_ as F,c as i,a as u,g as q,h as y,l as b,F as S,j as x,t as w,k as Z,o as n}from"./index-Re109noA.js";const J=j({name:"SpaceHangmanGame",components:{GameInstruction:V},setup(){const e=["Astre","Comète","Soleil","Terre","Lune","Etoile"],l="abcdefghijklmnopqrstuvwxyz".split(""),o=s(""),p=s([]),m=s([]),r=s(0),d=6,t=s(!1),c=s(!1),v=s(!1),f=s("Devinez le mot lié à l'espace !"),g=s(40),C=s(!1),N=s(!1),M=s(!0),T=s({title:"Pendu Spatial",players:"1 joueurs",time:"30 secondes",instruction:"Devinez le mot en utilisant les lettres à votre disposition"}),I=k(()=>t.value||c.value||v.value),$=k(()=>r.value>=d?`<svg width='200' height='200' xmlns='http://www.w3.org/2000/svg'>
          <defs>
      ...
      </svg>`),z=k(()=>`<svg width='100' height='100' xmlns='http://www.w3.org/2000/svg'>
        <defs>
      ...
      </svg>`),L=()=>{o.value=e[Math.floor(Math.random()*e.length)].toLowerCase(),p.value=Array(o.value.length).fill("_"),m.value=[],r.value=0,t.value=!1,c.value=!1,v.value=!1,f.value="Devinez le mot lié à l'espace !",g.value=40},B=()=>{M.value=!1,O()},H=a=>{if(!(m.value.includes(a)||I.value))if(m.value.push(a),o.value.includes(a)){for(let h=0;h<o.value.length;h++)o.value[h]===a&&(p.value[h]=a);p.value.includes("_")||(t.value=!0,f.value="Bravo ! Vous avez sauvé la planète de l'astéroïde !")}else r.value++,r.value>=d?(c.value=!0,p.value=o.value.split(""),f.value="Perdu ! L'astéroïde a détruit la planète ! Le mot était : "+o.value):f.value=`Attention ! L'astéroïde se rapproche... (${d-r.value} essais restants)`},U=()=>{const a=W("space-hangman");a==="alien-hunt-3d"?P.push({name:"alien-hunt-3d"}):a==="completion"?window.location.href="/completion":a?window.location.href=`/games/${a}`:window.location.href="/"};let G;A(()=>{G=setInterval(()=>{g.value>0?g.value--:(clearInterval(G),D())},1e3)}),E(()=>{clearInterval(G)});function D(){v.value=!0,f.value="Temps écoulé ! L'astéroïde a détruit la planète ! Le mot était : "+o.value,r.value=d}const O=()=>{L(),C.value=!0};return L(),{displayedWord:p,usedLetters:m,alphabet:l,errors:r,maxErrors:d,gameWon:t,gameLost:c,timeUp:v,gameOver:I,statusMessage:f,tryLetter:H,resetGame:L,planetSrc:$,asteroidSrc:z,continueToNextGame:U,timeLeft:g,gameStarted:C,gameOverMessageVisible:N,showInstructions:M,gameInstructions:T,onInstructionComplete:B}}}),K={class:"space-hangman-container"},Q={class:"game-area"},R={class:"planet-container"},X=["innerHTML"],Y=["innerHTML"],_={class:"word-display"},ee={key:1,class:"time-left"},te={class:"keyboard"},se=["onClick","disabled"];function ae(e,l,o,p,m,r){const d=Z("GameInstruction");return n(),i("div",K,[l[2]||(l[2]=u("h1",null,"Pendu Spatial",-1)),u("div",Q,[e.showInstructions?(n(),q(d,{key:0,title:e.gameInstructions.title,players:e.gameInstructions.players,time:e.gameInstructions.time,instruction:e.gameInstructions.instruction,onStart:e.onInstructionComplete},null,8,["title","players","time","instruction","onStart"])):y("",!0),u("div",R,[l[1]||(l[1]=u("div",{class:"asteroid-trajectory"},null,-1)),u("div",{innerHTML:e.planetSrc,class:"planet-image"},null,8,X),e.errors>0?(n(),i("div",{key:0,innerHTML:e.asteroidSrc,class:b(["asteroid-image","asteroid-position-"+e.errors])},null,10,Y)):y("",!0)]),u("div",_,[(n(!0),i(S,null,x(e.displayedWord,(t,c)=>(n(),i("span",{key:c,class:"letter-box"},w(t),1))),128))]),u("div",{class:b(["status-message",{win:e.gameWon,lose:e.gameLost,"time-up":e.timeUp}])},w(e.statusMessage),3),!e.timeUp&&!e.gameOver?(n(),i("div",ee," Temps restant : "+w(e.timeLeft)+" secondes ",1)):y("",!0),u("div",te,[(n(!0),i(S,null,x(e.alphabet,t=>(n(),i("button",{key:t,onClick:c=>e.tryLetter(t),disabled:e.usedLetters.includes(t)||e.gameOver||e.timeUp,class:b([{used:e.usedLetters.includes(t)},"key-button"])},w(t),11,se))),128))]),e.gameOver||e.timeUp?(n(),i("button",{key:2,onClick:l[0]||(l[0]=(...t)=>e.continueToNextGame&&e.continueToNextGame(...t)),class:"continue-btn"}," Continuer ")):y("",!0)])])}const ne=F(J,[["render",ae],["__scopeId","data-v-9a425845"]]);export{ne as default};
